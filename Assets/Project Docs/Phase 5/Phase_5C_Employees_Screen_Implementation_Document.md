# Phase 5C — Employees Screen Implementation Document

**Status:** Locked Phase 5 UI implementation source
**Screen route ID:** `screen.employees`
**Runtime UI:** Unity UI Toolkit only
**Canvas/UGUI allowed:** No
**Primary GDD references:** GDD_04, GDD_16.4, Appendix A.2
**Depends on:** Phase 4 UI Shell, theme foundation, routing, modal layer, and reusable component foundation

## 1. Purpose
Build the employee roster screen for browsing, filtering, selecting, and opening employee profiles.

## 2. Scope
- Employee list/table screen using the shared list-screen pattern.
- Tabs, toolbar, search, filters, data table, pagination/footer, right filter drawer.
- Employee profile detail modal structure.
- Placeholder/static employee ViewModel support.
...
- ScreenHeader with icon tile, title “Employees”, and subtitle “Manage your team, roles, and development.”
- Tabs below header.
- Toolbar with team dropdown, search field, Filters button, and optional Export button placeholder.
- DataTable occupying the main content region.
- RightFilterDrawer for filters.
- EmployeeProfile modal for selected employee details.
...
## 7. Interactions
- Row click opens Employee Profile modal.
- Filter button opens/closes right filter drawer.
- Apply Filters updates placeholder table state in Phase 5.
- Edit Profile button is placeholder unless Phase 6 wiring exists.
- Assignment changes must route through Application/Core later; do not mutate persistent state directly in UI.

## 8. Required States
- No employees yet state with link to Recruitment.
- Filtered empty state.
- Selected row state with teal rail/border.
- At-risk employee warning chip state.
- Former/archived muted row state.
...
## 10. Required Files
- `Assets/Project/UI/UXML/Screens/Employees/EmployeesScreen.uxml`
- `Assets/Project/UI/USS/Screens/Employees/EmployeesScreen.uss`
- `Assets/Project/Scripts/Presentation/UI/Screens/Employees/EmployeesView.cs`
- `Assets/Project/Scripts/Presentation/UI/Screens/Employees/EmployeesController.cs`
- `Assets/Project/Scripts/Presentation/UI/Screens/Employees/EmployeesViewModel.cs`

Optional helper ViewModels, if needed:
- `EmployeeRowViewModel.cs`
- `EmployeeFilterViewModel.cs`
- `EmployeeProfileViewModel.cs`
- `SkillBarViewModel.cs`
- `EmployeeActivityRowViewModel.cs`
...
- `EmployeeRowViewModel`
- `EmployeeFilterViewModel`
- `EmployeeProfileViewModel`
- `SkillBarViewModel`
- `EmployeeActivityRowViewModel`
...
## 14. Final Lock
Employees Screen is roster-level. Detailed employee information appears in the Employee Profile modal.
